...
public class AddPayment extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference = database.getReference().child("wallet").child(getCurrentTimeDate());
       ...
       getTypeOfPayment();
        BAddPayment.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                databaseReference.child("type").setValue(typeOfPaymentSelected);

                Toast.makeText(AddPayment.this, "Added new payment.", Toast.LENGTH_SHORT).show();
                startActivity(new Intent(AddPayment.this, Payments.class));
            }
        });
    }
